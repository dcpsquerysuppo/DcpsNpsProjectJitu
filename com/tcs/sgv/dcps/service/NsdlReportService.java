...
public class NsdlReportService extends ServiceImpl 
	 {
	...
	public ResultObject NsdlReport(Map inputMap) {
		...
		/*	DummyOfficeDAO lObjDummyOfficeDAO = new DummyOfficeDAOImpl(
			...
			DcpsCommonDAO lObjDcpsCommonDAO = new DcpsCommonDAOImpl(null, serv
					.getSessionFactory());
			NsdlReportsDAO lObjNsdlReportsDAO = new NsdlReportsDAOImpl(null, serv
					.getSessionFactory());
...
*/
		...
		if(!StringUtility.getParameter("finYear",request).equalsIgnoreCase("") && StringUtility.getParameter("finYear",request) != null
				...
				&& !StringUtility.getParameter("pranWise",request).equalsIgnoreCase("") && StringUtility.getParameter("pranWise",request) != null)
			{
				String lstrFinYear=StringUtility.getParameter("finYear", request);
				String lstrMonth=StringUtility.getParameter("month", request);
				String pranWise=StringUtility.getParameter("pranWise", request);
			
				System.out.println("pranWise************"+pranWise);
				List lLstDetails= lObjNsdlReportsDAO.getDetails(lstrFinYear,lstrMonth,gStrLocationCode,pranWise);
				...
				inputMap.put("pranWise", pranWise);
			...
			resObj.setViewName("NsdlReports");
