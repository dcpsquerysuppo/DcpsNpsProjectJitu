...
public class EmployeeContributionReportServiceImpl extends ServiceImpl{
	...
	public ResultObject loadEmployeeContribution(Map inputMap) throws Exception
	{
		...
		try
		{
			...
			resObj.setViewName("getEmployeeContributionReport");
		}
		catch (Exception e)
		{
