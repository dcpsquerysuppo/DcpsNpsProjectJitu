...
public class OldTransactionIdUpdateService extends ServiceImpl 
	 {
	...
	public ResultObject updateOldTransactionId(Map inputMap) {
		...
		/*	DummyOfficeDAO lObjDummyOfficeDAO = new DummyOfficeDAOImpl(
			...
			OldTransactionIdUpdateDAO lObjOldTransactionIdUpdateDAO = new OldTransactionIdUpdateDAOImpl(null,serv.getSessionFactory()); 
...
*/
	...
	public ResultObject updatedTransIdReport(Map inputMap) {
...
*/
		...
		/*	List lLstDummyOffice= lObjDummyOfficeDAO.getDummyOffices();*/
			...
			resObj.setResultValue(inputMap);
			resObj.setViewName("UpdatedTransactionIdReport");
