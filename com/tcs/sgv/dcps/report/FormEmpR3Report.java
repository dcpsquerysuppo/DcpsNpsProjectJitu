...
public class FormEmpR3Report extends DefaultReportDataFinder implements ReportDataFinder
{
	...
	public Collection findReportData(ReportVO lObjReport, Object criteria)throws ReportException
	{
		...
		try{
			...
			String StrSqlQuery = "";
			//Added by ashish for new header 			
			String treasuryCode="3301";
			String ddoCode="3301004339";
			...
			if (lObjReport.getReportCode().equals("8000095")) 
			{
				...
				SBQueryy.append(" where emp.SEVARTH_ID ='"+UserName+"' and fin.FIN_YEAR_ID="+lLngYearId+" ");  
				...
				try{
				lStrTreasuryName = getLocationName(Long.parseLong(treasuryCode));
				}catch(Exception e){}
