...
public class Form2ReportDelayed extends DefaultReportDataFinder implements
ReportDataFinder {
	...
	throws ReportException {
		...
		try {
			...
			if (report.getReportCode().equals("700049")) {
				...
				lSBQuery
				.append(" FROM trn_dcps_contribution TR,mst_dcps_emp EM,CMN_LOOKUP_MST look");
				...
				{
					RptVo = reportsDao.getReport("700050", report.getLangId(),
				...
				RptVoForHiddenColumns = reportsDao.getReport("700050", report
