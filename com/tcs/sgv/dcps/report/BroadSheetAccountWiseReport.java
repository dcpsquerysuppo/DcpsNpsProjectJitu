 ...
 ******************************************************************************
 * 	November 27, 2014		Ashish Sharma								
 *******************************************************************************
 */
 ...
 * @version 0.1
 * @since JDK 5.0 Nov 27, 2014
 */

	public class BroadSheetAccountWiseReport extends DefaultReportDataFinder{
		private static final Logger gLogger = Logger
			.getLogger(BroadSheetAccountWiseReport.class);
		...
		try {
			...
			if (report.getReportCode().equals("8000165")) {
				...
				String lStrEmployeeName = getEmployeeName(dcpsEmpId);
		     	 ...
		     	 String lStrTreasuryNames = getLocationName(LtreasuryCode);
		     	 String lStrYears = lObjDcpsCommonDAO.getFinYearForYearId(yearId);
				...
				{
					report.setAdditionalHeader("Account Maintained By :"+acMaintBy+"\r\nTreasury Name :"+lStrTreasuryNames+"\r\nEmployee Name :"+lStrEmployeeName+"\r\nFinancial Year :"+lStrYears);
			    }
				else{		
					report.setAdditionalHeader("Account Maintained By :"+acMaintBy+"\r\nTreasury Name :"+lStrTreasuryNames+"\r\nFinancial Year :"+lStrYears);
				}
...
//				lSBQuery.append(" nvl(SUM((CASE WHEN sg.month_id = 9 THEN (CASE WHEN type_of_payment = 700047 THEN nvl(tr.contribution,0) ELSE 0 END)END)),0) AS Sep_delayed,");
			...
			if(report.getReportCode().equals("8000166"))
			{
		...
		public List getAllTreasuries(String lStrLangId, String lStrLocId) {
			 ...
			 List<Object> lArrTreasuries = new ArrayList<Object>();
			  try
			  {
			      ...
			      String lStrBufLang = " SELECT locId, locName FROM CmnLocationMst WHERE departmentId in ( 100003,100006)   and LOC_ID<>1111 order by locId ";
