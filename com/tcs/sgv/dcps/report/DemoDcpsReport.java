...
public class DemoDcpsReport extends DefaultReportDataFinder {
    ...
    throws ReportException {
        ...
        try {
            ...
            if (report.getReportCode().equals("80000678")) {	// # REPORT ID 
                ...
                String treasuryCode = ((String) report.getParameterValue("treasuryCode")); //  # PARAMETER VALUE FROM JSP
                ...
                System.out.println("traesury code is "+treasuryCode);
              ...
              //  url = "ifms.htm?actionFlag=NsdlReport&finYear="+year+"&month="+month+"&pranWise="+pranWise;
                ...
                SBQueryQuery.append(" SELECT  SEVARTH_ID, emp_name , Basic_pay FROM MST_DCPS_EMP where    SUBSTR(DDO_CODE , 1,4) = "+treasuryCode+" ");  // # QUERY WILL FILL DATA IN TABLE
    ...
    public List getTreasuryList(String lStrLangId, String lStrLocId) {				// # METHOD NAME 
