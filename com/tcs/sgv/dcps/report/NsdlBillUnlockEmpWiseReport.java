...
public class NsdlBillUnlockEmpWiseReport extends DefaultReportDataFinder {

    private static final Logger gLogger = Logger
    .getLogger(NsdlBillUnlockEmpWiseReport.class);
    ...
    throws ReportException {
        ...
        try {
            ...
            if (report.getReportCode().equals("9000184")) {
                ...
                SBQuery.append(" inner join HR_PAY_PAYBILL paybill on paybill.PAYBILL_GRP_ID =head.PAYBILL_ID ");
                ...
                SBQuery.append(" where head.PAYBILL_YEAR= '"+year+"' and head.PAYBILL_MONTH='"+month+"'  and ddo.ddo_code='"+ddoCode+"' ");
                //and emp.reg_status=1 and emp.AC_DCPS_MAINTAINED_BY=700174 
                SBQuery.append(" and  head.APPROVE_FLAG=5 ");
