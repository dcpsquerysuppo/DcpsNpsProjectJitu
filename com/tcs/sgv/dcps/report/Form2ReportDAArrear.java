...
public class Form2ReportDAArrear extends DefaultReportDataFinder implements
ReportDataFinder {
	...
	throws ReportException {
		...
		try {
			...
			if (report.getReportCode().equals("700051")) {
				...
				lSBQuery.append(" AND TR.TYPE_OF_PAYMENT = 700048");
				...
				{
					RptVo = reportsDao.getReport("700052", report.getLangId(),
				...
				RptVoForHiddenColumns = reportsDao.getReport("700052", report
