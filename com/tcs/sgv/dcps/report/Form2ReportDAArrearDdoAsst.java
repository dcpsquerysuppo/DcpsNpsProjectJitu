...
public class Form2ReportDAArrearDdoAsst extends DefaultReportDataFinder implements ReportDataFinder {
	...
	public Collection findReportData(ReportVO report, Object criteria) throws ReportException {
		...
		try {
			...
			if (report.getReportCode().equals("700082")) {
				...
				lSBQuery.append(" SELECT EM.dcps_id,EM.emp_name,TR.startDate,TR.endDate,TR.BASIC_PAY,TR.DP,TR.DA,TR.contribution,TR.ddo_code,HPP.CDA,HPP.DED_ADJUST ");
				...
				if (lLstFinal != null && !lLstFinal.isEmpty()) {
					...
					while (it.hasNext()) {
						...
						gLogger.info("outside if value of CDA is"+tuple[9].toString());
				...
				if (dataListForTable.size() != 0) {
					RptVo = reportsDao.getReport("700052", report.getLangId(), report.getLocId()); // The 10 column report for table
				...
				RptVoForHiddenColumns = reportsDao.getReport("700052", report.getLangId(), report.getLocId());
