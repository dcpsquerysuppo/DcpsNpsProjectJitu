...
public class Form2ReportPayArrearDdoAsst extends DefaultReportDataFinder implements ReportDataFinder {
	...
	public Collection findReportData(ReportVO report, Object criteria) throws ReportException {
		...
		try {
			...
			if (report.getReportCode().equals("700084")) {
				...
				if (dataListForTable.size() != 0) {
					RptVo = reportsDao.getReport("700054", report.getLangId(), report.getLocId()); // The 10 column report for table
				...
				RptVoForHiddenColumns = reportsDao.getReport("700054", report.getLangId(), report.getLocId());
