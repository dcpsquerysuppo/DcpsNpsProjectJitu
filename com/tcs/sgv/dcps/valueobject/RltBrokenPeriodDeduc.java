...
public class RltBrokenPeriodDeduc {
	
	private Long brokenPeriodDeducId;
	private MstBrokenPeriodPay rltBrokenPeriodId;
	private Long deducCode;
	private Long deducValue;
	private Long langId;
	private Long locId;
	private Long dbId;
	...
	public Long getBrokenPeriodDeducId() {
		return brokenPeriodDeducId;
	}
	public void setBrokenPeriodDeducId(Long brokenPeriodDeducId) {
		this.brokenPeriodDeducId = brokenPeriodDeducId;
	}
	...
	public Long getDeducValue() {
		return deducValue;
	}
	public void setDeducValue(Long deducValue) {
