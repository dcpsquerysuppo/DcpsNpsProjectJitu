...
public class DdoOffice implements java.io.Serializable {
	...
	//added by arpan
	private String dcpsDdoOfficeAddress1New;
	private String dcpsDdoOfficeAddress2New;
	private String dcpsDdoOfficeAddress3New;
	private String dcpsDdoOfficeTownNew;
	private String dcpsDdoOfficeVillageNew;
	private String dcpsDdoOfficeTelNo1New;
	private String dcpsDdoOfficeTelNo2New;
	private String dcpsDdoOfficeEmailNew;
	//end
	
	public String getDcpsDdoOfficeAddress1New() {
		return dcpsDdoOfficeAddress1New;
	}

	public void setDcpsDdoOfficeAddress1New(String dcpsDdoOfficeAddress1New) {
		this.dcpsDdoOfficeAddress1New = dcpsDdoOfficeAddress1New;
	}

	public String getDcpsDdoOfficeAddress2New() {
		return dcpsDdoOfficeAddress2New;
	}

	public void setDcpsDdoOfficeAddress2New(String dcpsDdoOfficeAddress2New) {
		this.dcpsDdoOfficeAddress2New = dcpsDdoOfficeAddress2New;
	}

	public String getDcpsDdoOfficeAddress3New() {
		return dcpsDdoOfficeAddress3New;
	}

	public void setDcpsDdoOfficeAddress3New(String dcpsDdoOfficeAddress3New) {
		this.dcpsDdoOfficeAddress3New = dcpsDdoOfficeAddress3New;
	}

	public String getDcpsDdoOfficeTownNew() {
		return dcpsDdoOfficeTownNew;
	}

	public void setDcpsDdoOfficeTownNew(String dcpsDdoOfficeTownNew) {
		this.dcpsDdoOfficeTownNew = dcpsDdoOfficeTownNew;
	}

	public String getDcpsDdoOfficeVillageNew() {
		return dcpsDdoOfficeVillageNew;
	}

	public void setDcpsDdoOfficeVillageNew(String dcpsDdoOfficeVillageNew) {
		this.dcpsDdoOfficeVillageNew = dcpsDdoOfficeVillageNew;
	}

	public String getDcpsDdoOfficeTelNo1New() {
		return dcpsDdoOfficeTelNo1New;
	}

	public void setDcpsDdoOfficeTelNo1New(String dcpsDdoOfficeTelNo1New) {
		this.dcpsDdoOfficeTelNo1New = dcpsDdoOfficeTelNo1New;
	}

	public String getDcpsDdoOfficeTelNo2New() {
		return dcpsDdoOfficeTelNo2New;
	}

	public void setDcpsDdoOfficeTelNo2New(String dcpsDdoOfficeTelNo2New) {
		this.dcpsDdoOfficeTelNo2New = dcpsDdoOfficeTelNo2New;
	}

	public String getDcpsDdoOfficeEmailNew() {
		return dcpsDdoOfficeEmailNew;
	}

	public void setDcpsDdoOfficeEmailNew(String dcpsDdoOfficeEmailNew) {
		this.dcpsDdoOfficeEmailNew = dcpsDdoOfficeEmailNew;
	}
