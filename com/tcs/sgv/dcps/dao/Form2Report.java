...
import com.tcs.sgv.dcps.report.PrintFormR2ConsolidatedReport;
	...
	throws ReportException {
		...
		try {
			...
			if (report.getReportCode().equals("700037")) {
				...
				lSBQuery.append(" SELECT EM.dcps_id,EM.emp_name,HES.emp_id,EM.dcps_emp_id,HPP.PO, HPP.D_PAY, HPP.DA, HPP.DCPS, EM.dcps_emp_id,HPP.CDA,HPP.DED_ADJUST ");
