...
public class MstPensionerNomineeDtls implements java.io.Serializable
{
    ...
    public MstPensionerNomineeDtls(Long nomineeId, String pensionerCode,
			String name, BigDecimal percent, Integer trnCounter,
			BigDecimal createdUserId, BigDecimal createdPostId,
			Date createdDate, BigDecimal updatedUserId,
			BigDecimal updatedPostId, Date updatedDate, String bankCode,
			Long branchCode, String accountNo, String locationCode,
			String relationship, Date dateOfBirth) {
		super();
		this.nomineeId = nomineeId;
		this.pensionerCode = pensionerCode;
		this.name = name;
