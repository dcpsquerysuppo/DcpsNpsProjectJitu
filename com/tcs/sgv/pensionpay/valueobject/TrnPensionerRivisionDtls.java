...
public class TrnPensionerRivisionDtls implements Serializable {
	...
	private String agPPONo;
	
	private String agPensionerName;
	
	private String ifmsPPONo;
	
	private String ifmsPensionerName;
	
	private Date ppoAcceptDate;
	...
	public TrnPensionerRivisionDtls(Long rivisionDtlsId,String agPPONo,String agPensionerName,String ifmsPPONo,String ifmsPensionerName,String pensionerCode) {
		
		this.rivisionDtlsId = rivisionDtlsId;
		this.agPPONo = agPPONo;
		this.agPensionerName = agPensionerName;
		this.ifmsPPONo = ifmsPPONo;
		this.ifmsPensionerName = ifmsPensionerName;
	...
	public TrnPensionerRivisionDtls(Long rivisionDtlsId, Long pensionRequestId,
			...
			String agPPONo, String agPensionerName, String ifmsPPONo,
			String ifmsPensionerName, Date ppoAcceptDate, String cvpOrderNo,
			String gpoOrderNo) {
		super();
		this.rivisionDtlsId = rivisionDtlsId;
		...
		this.ifmsPPONo = ifmsPPONo;
		this.ifmsPensionerName = ifmsPensionerName;
		this.ppoAcceptDate = ppoAcceptDate;
		this.cvpOrderNo = cvpOrderNo;
		this.gpoOrderNo = gpoOrderNo;
	}
	...
	public String getAgPPONo() {
		return agPPONo;
	}

	public void setAgPPONo(String agPPONo) {
		this.agPPONo = agPPONo;
	}

	public String getAgPensionerName() {
		return agPensionerName;
	}

	public void setAgPensionerName(String agPensionerName) {
		this.agPensionerName = agPensionerName;
	}

	public String getIfmsPPONo() {
		return ifmsPPONo;
	}

	public void setIfmsPPONo(String ifmsPPONo) {
		this.ifmsPPONo = ifmsPPONo;
	}

	public String getIfmsPensionerName() {
		return ifmsPensionerName;
	}

	public void setIfmsPensionerName(String ifmsPensionerName) {
		this.ifmsPensionerName = ifmsPensionerName;
	}

	public Date getPpoAcceptDate() {
		return ppoAcceptDate;
	}

	public void setPpoAcceptDate(Date ppoAcceptDate) {
		this.ppoAcceptDate = ppoAcceptDate;
	}
	...
	public String getGpoOrderNo() {
		return gpoOrderNo;
	}

	public void setGpoOrderNo(String gpoOrderNo) {
		this.gpoOrderNo = gpoOrderNo;
	}
