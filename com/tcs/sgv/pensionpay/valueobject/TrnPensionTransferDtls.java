...
public class TrnPensionTransferDtls implements java.io.Serializable {
	...
	private Integer lastPayMonthYear;
	
	private BigDecimal lastPayAmount;
	
	private Date applnReceiveDate;
	// Constructors
	...
	public TrnPensionTransferDtls(Long transferDtlsId, String ppoNo,
			...
			Date updatedDate, String pensionerCode, String remarks,
			Character agFlag, String registrationNo, String otherStateName,
			Date ppoInwardDate, Date ppoRegDate, Date commensionDate,
			String requestId, Integer lastPayMonthYear, BigDecimal lastPayAmount,Date applnReceiveDate) {
		super();
		this.transferDtlsId = transferDtlsId;
		this.ppoNo = ppoNo;
		...
		this.lastPayMonthYear = lastPayMonthYear;
		this.lastPayAmount = lastPayAmount;
		this.applnReceiveDate = applnReceiveDate;
	}
	...
	public Integer getLastPayMonthYear() {
		return lastPayMonthYear;
	}

	public void setLastPayMonthYear(Integer lastPayMonthYear) {
		this.lastPayMonthYear = lastPayMonthYear;
	}
	...
	public Date getApplnReceiveDate() {
		return applnReceiveDate;
	}

	public void setApplnReceiveDate(Date applnReceiveDate) {
		this.applnReceiveDate = applnReceiveDate;
	}
