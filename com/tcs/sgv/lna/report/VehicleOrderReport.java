...
public class VehicleOrderReport extends DefaultReportDataFinder implements ReportDataFinder {

	private static final Logger gLogger = Logger.getLogger(VehicleOrderReport.class);
	public static String newline = System.getProperty("line.separator");

	private ResourceBundle gObjRsrcBndle = ResourceBundle.getBundle("resources/lna/VehicleOrderReport");
	...
	public Collection findReportData(ReportVO lObjReport, Object criteria) throws ReportException {
		...
		try {
			...
			if (lObjReport.getReportCode().equals("8000063")) {
				...
				if (lLstEmpDtls != null && !lLstEmpDtls.isEmpty()) {
					...
					inputMap.put("advanceType", 800030L);
	...
	public void updateOrderNo(String lStrOrderNo,List<String> lLstSevaarthId,List<String> lLstTrnsId){
		...
		try {
			lSBQuery.append("UPDATE MstLnaMotorAdvance SET orderNo = :OrderNo,orderDate = :currDate ");			
