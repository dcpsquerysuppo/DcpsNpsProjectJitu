...
public class MstLnaRequest {
	...
	public Long getLoanAdvanceId() {
		return loanAdvanceId;
	}

	public void setLoanAdvanceId(Long loanAdvanceId) {
		this.loanAdvanceId = loanAdvanceId;
	}
