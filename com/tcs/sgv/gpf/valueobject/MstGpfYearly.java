...
public class MstGpfYearly {
	private Long mstGpfYearlyId;
	...
	private Double withdrawalSanctioned;
	...
	public Long getMstGpfYearlyId() {
		return mstGpfYearlyId;
	}

	public void setMstGpfYearlyId(Long mstGpfYearlyId) {
		this.mstGpfYearlyId = mstGpfYearlyId;
	}
	...
	public Double getWithdrawalSanctioned() {
		return withdrawalSanctioned;
	}

	public void setWithdrawalSanctioned(Double withdrawalSanctioned) {
		this.withdrawalSanctioned = withdrawalSanctioned;
	}
