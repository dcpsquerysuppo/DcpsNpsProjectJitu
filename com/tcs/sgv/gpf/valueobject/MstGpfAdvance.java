...
public class MstGpfAdvance {
	private Long mstGpfAdvanceId;
	...
	private Double oddInstallment;
	private String clubbedReqTrnId;
	private Double recoveredAmount;
	private Double outstandingAmount;
	private Character specialCase;
	...
	private Date releaseDate3;
	private Double installment4;
	private Date releaseDate4;
	...
	private Date voucherDate2;
	private String voucherNo3;
	private Date voucherDate3;
	private String voucherNo4;
	private Date voucherDate4;
	private Long oddInstallmentNo;
	private Integer outstandingInstallmentPrevFinYear;
	private String dataEntry;
	private String sevaarthId;
	
	private Character specialCaseFor90Perc;
	
	public Long getOddInstallmentNo() {
		return oddInstallmentNo;
	}

	public void setOddInstallmentNo(Long oddInstallmentNo) {
		this.oddInstallmentNo = oddInstallmentNo;
	}

	public Long getMstGpfAdvanceId() {
		return mstGpfAdvanceId;
	}

	public void setMstGpfAdvanceId(Long mstGpfAdvanceId) {
		this.mstGpfAdvanceId = mstGpfAdvanceId;
	}
	...
	public Long getPurposeCategory() {
		return purposeCategory;
	}

	public void setPurposeCategory(Long purposeCategory) {
	...
	public Double getOddInstallment() {
		return oddInstallment;
	}

	public void setOddInstallment(Double oddInstallment) {
	...
	public Integer getInstallmentsLeft() {
		return installmentsLeft;
	}

	public void setInstallmentsLeft(Integer installmentsLeft) {
	...
	public Date getReleaseDate3() {
		return releaseDate3;
	}

	public void setReleaseDate3(Date releaseDate3) {
	...
	public Date getReleaseDate4() {
		return releaseDate4;
	}

	public void setReleaseDate4(Date releaseDate4) {
		this.releaseDate4 = releaseDate4;
	}
	...
	public String getClubbedReqTrnId() {
		return clubbedReqTrnId;
	}

	public void setClubbedReqTrnId(String clubbedReqTrnId) {
		this.clubbedReqTrnId = clubbedReqTrnId;
	}
	...
	public Character getSpecialCase() {
		return specialCase;
	}

	public void setSpecialCase(Character specialCase) {
	...
	public Date getVoucherDate2() {
		return voucherDate2;
	}

	public void setVoucherDate2(Date voucherDate2) {
		this.voucherDate2 = voucherDate2;
	}

	public String getVoucherNo3() {
		return voucherNo3;
	}

	public void setVoucherNo3(String voucherNo3) {
		this.voucherNo3 = voucherNo3;
	}

	public Date getVoucherDate3() {
		return voucherDate3;
	}

	public void setVoucherDate3(Date voucherDate3) {
		this.voucherDate3 = voucherDate3;
	}

	public String getVoucherNo4() {
		return voucherNo4;
	}

	public void setVoucherNo4(String voucherNo4) {
		this.voucherNo4 = voucherNo4;
	}

	public Date getVoucherDate4() {
		return voucherDate4;
	}

	public void setVoucherDate4(Date voucherDate4) {
		this.voucherDate4 = voucherDate4;
	}

	public Integer getOutstandingInstallmentPrevFinYear() {
		return outstandingInstallmentPrevFinYear;
	}

	public void setOutstandingInstallmentPrevFinYear(
			Integer outstandingInstallmentPrevFinYear) {
		this.outstandingInstallmentPrevFinYear = outstandingInstallmentPrevFinYear;
	}
	...
	public Character getSpecialCaseFor90Perc() {
		return specialCaseFor90Perc;
	}

	public void setSpecialCaseFor90Perc(Character specialCaseFor90Perc) {
		this.specialCaseFor90Perc = specialCaseFor90Perc;
	}
