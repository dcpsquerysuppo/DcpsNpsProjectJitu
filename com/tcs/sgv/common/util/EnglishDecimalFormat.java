...
public static String convert1(long number) {
    ...
    public static String convert1WithSpace(long number) {
        ...
        if (n != 0)
        {
           ...
           soFar = s + majorNamesWithSpace[place] + soFar;
         }
        place++;
        number /= 1000;
    ...
    private static String convertLessThanOneThousandWithSpace(int number) {
        ...
        if (number % 100 < 20){
            soFar = numNamesWithSpace[number % 100];
            number /= 100;
           }
        else {
            soFar = numNamesWithSpace[number % 10];
            number /= 10;

            soFar = tensNamesWithSpace[number % 10] + soFar;
            number /= 10;
           }
        if (number == 0) return soFar;
        return numNamesWithSpace[number] + " Hundred" + soFar;
    }
