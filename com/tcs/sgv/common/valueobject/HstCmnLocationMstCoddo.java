...
/**
 * HstCmnLocationMstCoddo generated by hbm2java
 */
public class HstCmnLocationMstCoddo implements java.io.Serializable {

	// Fields    

	private HstCmnLocationMstCoddoId id;
	...
	/** default constructor */
	public HstCmnLocationMstCoddo() {
	}

	/** minimal constructor */
	public HstCmnLocationMstCoddo(HstCmnLocationMstCoddoId id, String locName,
			String locShortName, Byte langId, Long departmentId,
			Long parentLocId, String locPin, Long typeLookupId, Date startDate,
			Integer activateFlag, Integer createdBy, Integer createdByPost,
	...
	public HstCmnLocationMstCoddo(HstCmnLocationMstCoddoId id, String locName,
			String locShortName, Byte langId, Long departmentId,
			Long parentLocId, String locAddr1, String locAddr2, Long locCityId,
			Long locDistrictId, Long locStateId, String locPin,
			Long typeLookupId, Date startDate, Date endDate, Integer activateFlag,
			Integer createdBy, Integer createdByPost, Date createdDate,
			Integer updatedBy, Integer updatedByPost, Date updatedDate,
			String locationCode, Long locTalukaId, String officeCode,
			Long locCategoryId) {
		this.id = id;
		this.locName = locName;
		this.locShortName = locShortName;
	...
	// Property accessors
	public HstCmnLocationMstCoddoId getId() {
		return this.id;
	}

	public void setId(HstCmnLocationMstCoddoId id) {
		this.id = id;
	}
